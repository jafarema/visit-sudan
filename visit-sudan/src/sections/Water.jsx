...
export default function Water() {
  return (
    <section
      id="water"
      className="relative grid min-h-[90vh] grid-cols-1 md:grid-cols-2"
    >
      <div className="relative flex items-center bg-ink p-8 md:p-16">
        <div className="max-w-md">
          <p className="eyebrow">Water · 03 / 09</p>
          <h2 className="font-display mt-4 text-5xl leading-tight tracking-tight md:text-7xl">
            The Nile{" "}
            <span className="italic text-gold-gradient">remembers.</span>
          </h2>
          <p className="mt-6 text-bone/72 leading-7">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3 text-[10px] uppercase tracking-ultra font-mono text-bone/55">
            {PLACES.map((p, i) => (
