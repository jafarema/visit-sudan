...
export default function Culture() {
  return (
    <section id="culture" className="relative px-6 py-32 md:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        <motion.h2
          ...
          className="font-display mt-4 max-w-5xl text-5xl leading-[0.95] tracking-mega md:text-9xl"
        >
          Come for the places.{" "}
          <span className="italic text-gold-gradient">Remember the people.</span>
        </motion.h2>
